...
class Netflix {
  constructor(options) {
    ...
    this.getRatingHistory = this.getRatingHistory.bind(this)
    this.getViewingHistory = this.getViewingHistory.bind(this)
    this.__getViewingHistory = this.__getViewingHistory.bind(this)
    this.__setRating = this.__setRating.bind(this)
    ...
    this.__getLoginForm = this.__getLoginForm.bind(this)
    this.__postLoginForm = this.__postLoginForm.bind(this)
    this.__getRatingHistory = this.__getRatingHistory.bind(this)
    this.__apiRequest = this.__apiRequest.bind(this)
    this.__getContextData = this.__getContextData.bind(this)
    this.__getContextDataFromUrls = this.__getContextDataFromUrls.bind(this)
  }
